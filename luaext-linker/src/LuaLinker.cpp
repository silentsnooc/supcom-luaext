...
{
    //LOGGER.LogMessage(std::wstring(L"Linking .."));

    unsigned int checksum = SUPCOM_1_5_3656;
    //wchar_t procFileName[MAX_PATH];

    //MessageBox(NULL, L"LuaLinker::Link", L"LuaLinker.cpp", MB_OK);

   /* if(GetModuleFileName(GetCurrentModule(), procFileName, MAX_PATH) == 0)
    {
        MessageBox(NULL, L"ERROR! Couldn't get process image file name.", L"LuaLinker.cpp", MB_OK);
        LOGGER.LogError("ERROR! Couldn't get process image file name.\n");
        return false;
    }*/

    wchar_t procFileName[MAX_PATH] = L"C:\\ProgramData\\FAForever\\bin\\ForgedAlliance.exe";

    //LOGGER.LogMessage(std::wstring(L"Process file name: ") + std::wstring(procFileName));
    ...
    if(true)
    {
        ...
        case SUPCOM_1_5_3599: // Supreme Commander Forged Alliance 1.5.3599 official version
            ...
            */
            ...
            //lua_atpanic     = (lualinker_atpanic)(base + 0x); // SupCom has no definition of this function
            ...
            */
            ...
            //lua_iscfunction = (lualinker_iscfunction)(base + 0x); // SupCom has no definition of this function
            ...
            //lua_touserdata  = (lualinker_touserdata)(base + 0x0090C410); // SupCom has no definition of this function (actually SupCom has a lua_touserdata with a different syntax)
            ...
            */
            ...
            //lua_newuserdata     = (lualinker_newuserdata)(base + 0x0090D040); // SupCom has no definition of this function (actually SupCom has a lua_newuserdata with a different syntax)
        ...
        default: // unknown checksum
            //LOGGER.LogMessage("ERROR! You have an unknown version of Supreme Commander.\n");
            break;
        }
    }
